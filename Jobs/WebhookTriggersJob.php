...
class WebhookTriggersJob extends Job implements ShouldQueue
{
    ...
    {
        try {
            $webhookTriggers = BaseWebhookGlobalTrigger::whereIn('id', $this->webhook_trigger_ids)
                ->with([
            ...
            foreach ($webhookTriggers as $webhookTrigger) {
                ...
                foreach ($webhookTriggerValues as $webhookTriggerValue) {
                    ...
                    if (empty($this->resource_fields_values)) {
                        ...
                        $send_data['company'] = 'FieldPulse_' . $this->object->company->title . '_' . $this->object->company_id;
    ...
    {
        if ($this->object instanceof BaseJob && !empty($this->objectParams)) {
