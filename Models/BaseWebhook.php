...
class BaseWebhook extends Model
{
    ...
    protected $table = 'FpExternalServiceWebhooks';
    ...
    {
        return $this->belongsTo(BaseWebhookTriggerValue::class, 'webhook_trigger_value_id');
    }

    public function webhookRequests(): HasMany
    {
        return $this->hasMany(BaseWebhookRequest::class, 'webhook_id');
    }
