...
class BaseWebhookGlobalTrigger extends Model
{
    use SoftDeletes;
    use Scopes;
    ...
    protected $table = 'FpExternalServiceWebhookGlobalTriggers';
    ...
    {
        return $this->hasMany(BaseWebhookTriggerValue::class, 'global_trigger_id');
    }
